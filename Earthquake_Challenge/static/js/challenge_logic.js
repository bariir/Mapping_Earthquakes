...
let tectonic_Data = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
 ...
 // Accessing the major earthquakes GeoJSON URL.
 let majorEarthquake_Data = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
...
d3.json(majorEarthquake_Data).then(function(data) {
